                ...
                <div class="accordion-content p-5 pt-0 flex flex-col gap-5">
                    ...
                    <div class="flex flex-col rounded-[20px] border border-[#E8EFF7] p-5 gap-5">
                        ...
                        <div class="flex items-center rounded-[20px] gap-[14px]">
                            ...
                            <div>
                                <p class="font-bold text-xl leading-[30px]">{{ ucfirst($tier->class_type) }} Class</p>
        ...
        <div id="Plane" class="relative flex w-[558px] shrink-0 mt-[30px] mx-auto">
            ...
            <div class="relative flex flex-col justify-end">
                ...
                <form action="{{ route('booking.confirmSeat', $flight->flight_number) }}" method="POST" class="relative px-[56px] pb-[60px]" id="form-seat">
                    ...
                    <p class="text-center font-bold text-xl leading-[30px]">{{ ucfirst($tier->class_type) }} Class</p>
                    ...
                    <div id="Seats-Options"
                        class="flex flex-wrap w-full gap-y-8 @if ($tier->class_type == 'business') gap-x-10 px-[33px] @else gap-x-[14px] @endif">
                        @foreach ($flight->seats->where('class_type', $tier->class_type) as $seat)
                            <label
                                ...
                                <input type="checkbox" name="seat" class="seat-checkbox absolute top-1/2 left-1/2 opacity-0"
                                    @if (!$seat->is_available) disabled @endif @if ($seat->is_available) @endif>
...
@section('scripts')
<script>const basePrice = {{ $tier->price }};</script>
